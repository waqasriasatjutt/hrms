...
class ACSOphthalmologyEvaluation(models.Model):
    ...
    date = fields.Datetime('Date', default=fields.Datetime.now, help="Date of Consultation", states=STATES)
...
class AcsOphthalmologyFindings(models.Model):
    ...
    evaluation_id = fields.Many2one('acs.ophthalmology.evaluation', 'Evaluation')
    ...
    affected_eye = fields.Selection([
        ("right","right"),
        ("left","left"),
        ("both","both")],'Eye',help="Affected eye",sort=False)
