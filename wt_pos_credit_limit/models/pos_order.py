...
class POSOrder(models.Model):
    ...
    def _process_saved_order(self, draft):
        ...
        self.create_receivable_move_line()
        return res

    def create_receivable_move_line(self):
        credit_payments = self.payment_ids.filtered(lambda p: p.payment_method_id and p.payment_method_id.credit_journal)
