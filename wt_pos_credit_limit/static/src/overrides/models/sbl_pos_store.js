...
patch(PosStore.prototype, {
    ...
    async updatePartnerAvailableCredit(partner) {
        ...
        const available_credit = await this.data.call("res.partner", "get_available_credit", [
            partnerParent.id,
        ]);
        partnerParent.update({ available_credit });
    ...
    getPartnerAvailableCredit(partner) {
        ...
        return partnerParent.available_credit;
    },
});