...
################################################################################
{
    ...
    'summary': """This module enables you to display time-based products in POS.
     The item will vary as time goes on""",
    ...
    mentioned by the user in the pos configuration. The user can specify 
    the product there""",
