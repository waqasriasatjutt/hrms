...
class PaymentTokenSelector(models.TransientModel):
    ...
    @staticmethod
    def generate_client_reference_code(provider_id, provider_token):
        random_suffix = str(random.randint(100000, 999999))
        return f"TOKINV{provider_id}{provider_token}{random_suffix}"
    ...
    def action_confirm(self):
        ...
        result = authorize_payment(
            ...
            type='CARD' if self.payment_token_id.token_type == 'card_payment' else 'CHECK',
