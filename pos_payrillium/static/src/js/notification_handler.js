  ...
  start(env, { action: actionService, notification: notificationService }) {
    ...
    notificationService.add = function (message, options = {}) {
      ...
      if (
        ...
        console.log(
          "Payment notification detected, will close after 5 seconds..."
        );
        ...
        setTimeout(() => {
          ...
          if (
            ...
            console.log(
              "Payment processed notification detected, reloading page..."
            );
            window.location.reload();
          } else {
            console.log("Closing payment notification (no reload needed)...");
          }
        }, 5000);
      }
